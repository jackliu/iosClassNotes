    ...
    */
    ...
    //新建一个卡车对象
        ...
        */
        ...
        /*
        //第九天代码
        //UseNSNumber *un = [[UseNSNumber alloc]init];
        //[un createNumber];
        //[un createFormatNum];
        UseString *us = [[UseString alloc]init];
        [us createString];
        */
        
        /*
        //第十天代码
        RunDay10 *day10 = [[RunDay10 alloc]init];
        [day10 run];
        
        //第十一天
        RunDay11 *day11=[[RunDay11 alloc]init];
        [day11 run];
        */
        
        //第十二天
        RunDay12  *day12 = [[RunDay12 alloc]init];
        [day12 run];
